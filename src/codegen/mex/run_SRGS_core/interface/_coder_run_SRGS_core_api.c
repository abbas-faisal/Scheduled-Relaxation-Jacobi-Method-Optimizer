 ...
 *
 * _coder_run_SRGS_core_api.c
 *
 * Code generation for function '_coder_run_SRGS_core_api'
 *
 */

/* Include files */
#include "_coder_run_SRGS_core_api.h"
...
static emlrtRTEInfo d_emlrtRTEI = {
    1,                          /* lineNo */
    1,                          /* colNo */
    "_coder_run_SRGS_core_api", /* fName */
    ""                          /* pName */
};
...
void run_SRGS_core_api(const mxArray *const prhs[12], int32_T nlhs,
                       const mxArray *plhs[2])
{
  ...
  emxInit_real_T(&st, &res_history, 1, &d_emlrtRTEI);
  run_SRGS_core(&st, w1, w2, N_x, N_y, dx, U_init, B, max_iter, max_residual,
...
/* End of code generation (_coder_run_SRGS_core_api.c) */
